...
flow:
  ...
  workflow:
    - test_empty_size:
        do:
          microfocus.te.rosemary.test.rosemary.subflows.test_get_size.test_empty_size: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: test_not_empty_size
    - test_not_empty_size:
        do:
          microfocus.te.rosemary.test.rosemary.subflows.test_get_size.test_not_empty_size: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: SUCCESS
  results:
