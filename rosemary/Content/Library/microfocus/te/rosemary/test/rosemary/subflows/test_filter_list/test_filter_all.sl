...
flow:
  ...
  workflow:
    - test_empty_filter:
        do:
          microfocus.te.rosemary.test.rosemary.subflows.test_filter_list.test_empty_filter: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: test_not_empty_filter
    - test_not_empty_filter:
        do:
          microfocus.te.rosemary.test.rosemary.subflows.test_filter_list.test_not_empty_filter: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: test_filter_cycle
    - test_filter_cycle:
        do:
          microfocus.te.rosemary.test.rosemary.subflows.test_filter_list.test_filter_cycle: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: SUCCESS
  results:
