...
flow:
  ...
  workflow:
    - add_element_into_empty_list:
        do:
          microfocus.te.rosemary.test.rosemary.util.test_add_element.add_element_into_empty_list: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: add_element_into_non_empty_list
    - add_element_into_non_empty_list:
        do:
          microfocus.te.rosemary.test.rosemary.util.test_add_element.add_element_into_non_empty_list: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: add_element_non_default_delimiter
    - add_element_non_default_delimiter:
        do:
          microfocus.te.rosemary.test.rosemary.util.test_add_element.add_element_non_default_delimiter: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: add_element_cycle
    - add_element_cycle:
        do:
          microfocus.te.rosemary.test.rosemary.util.test_add_element.add_element_cycle: []
        navigate:
          - FAILURE: on_failure
          - SUCCESS: SUCCESS
  results:
